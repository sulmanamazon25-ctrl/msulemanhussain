...
const urlList = [
  ...
  `${siteUrl}/en/expertise/spain-money-guides`,
  `${siteUrl}/es/expertise/spain-money-guides`,
  `${siteUrl}/en/tools/calculadora-de-salario`,
  `${siteUrl}/es/tools/calculadora-de-salario`,
  `${siteUrl}/en/tools/calculadora-de-finiquito`,
  `${siteUrl}/es/tools/calculadora-de-finiquito`,
  `${siteUrl}/en/tools/cuota-de-autonomos`,
  `${siteUrl}/es/tools/cuota-de-autonomos`,
  `${siteUrl}/en/tools/calculadora-de-hipoteca`,
  `${siteUrl}/es/tools/calculadora-evau-2026`,
  `${siteUrl}/en/tools/validador-dni-nie`,
  `${siteUrl}/en/about`,
  `${siteUrl}/en/contact`,
  `${siteUrl}/llms.txt`,
  `${siteUrl}/sitemap.xml`,
