...
export const products: Product[] = [
  {
    ...
    previewImage: "/products/shots/downitx.png",
  ...
  },
  {
    ...
    previewImage: "/products/shots/pinquill.png",
  ...
  },
  {
    ...
    previewImage: "/products/shots/wasup.png",
  ...
  },
  {
    ...
    previewImage: "/products/shots/pickleball.png",
  ...
  },
  {
    slug: "spain-eats",
    name: "Spain Eats",
    tagline: "The English-language guide to Spanish food.",
    category: "Content Platform",
    status: "LIVE",
    year: 2024,
    multilingual: true,
    locales: ["EN"],
    liveUrl: "https://spaineats.info/",
    logo: "/products/spain-eats-mark.svg",
    previewImage: "/products/shots/spain-eats.png",
    stack: ["WordPress", "SEO", "Regional guides", "Food tools"],
    accent: "#c45c26",
    accentSoft: "rgba(196, 92, 38, 0.14)",
    problem:
      "English readers struggle to find connected, regional Spanish food knowledge — dishes, ingredients, and culture stay siloed in listicles.",
    solution:
      "Spain Eats is a live culinary knowledge system: regions, dishes, ingredients, recipes, drinks, places, and free cooking tools — linked as one guide.",
    whyExists:
      "Spanish cuisine deserves a structured English reference, not scattered blog posts.",
    happeningNow: "Live at spaineats.info — magazine hubs, tools, and places directory.",
    howItWorks: ["Region map", "Dish explainers", "Ingredient notes", "Recipes", "Tools & places"],
    details: {
      frontend: "Magazine hubs + tools + places discovery",
      backend: "WordPress + custom mu-plugins",
      ai: "Research assist — editorial review stays human",
      infrastructure: "Coolify WordPress production",
      apis: "Places REST + internal tools",
      architecture: "Topical authority content system",
    },
    metrics: [
      { label: "Focus", value: "ES cuisine" },
      { label: "Lang", value: "EN" },
      { label: "Status", value: "Live" },
    ],
    relatedProjectSlugs: ["client-growth"],
  ...
  },
  {
    slug: "bokily",
    name: "Bokily",
    tagline: "Swap books with people nearby.",
    category: "Local Marketplace",
    status: "LIVE",
    year: 2026,
    multilingual: true,
    locales: ["EN", "ES"],
    liveUrl: "https://www.bokily.com/",
    logo: "/products/bokily-mark.svg",
    previewImage: "/products/shots/bokily.png",
    stack: ["Mobile", "Location", "Chat", "QR meetup"],
    accent: "#0d9488",
    accentSoft: "rgba(13, 148, 136, 0.14)",
    problem:
      "Readers buy and discard books while nearby shelves stay invisible — local swaps need trust, distance privacy, and a clear meetup flow.",
    solution:
      "Bokily connects readers nearby: list books (ISBN or manual), find matches by distance, chat in-app, and confirm handoffs with QR — Spain first, free to join.",
    whyExists:
      "Book culture should circulate locally without payments between users or exposing exact home addresses.",
    happeningNow: "Live at bokily.com — Android early access open for Spain.",
    howItWorks: ["Add books", "Find nearby matches", "Request a swap", "Chat & meet", "QR confirm"],
    details: {
      frontend: "Marketing site + Android app (early access)",
      backend: "Accounts, listings, swap requests, chat",
      ai: "Not required for core swap loop",
      infrastructure: "Location-rounded discovery for privacy",
      apis: "ISBN lookup, push notifications, QR confirmation",
      architecture: "Location-first peer book exchange",
    },
    metrics: [
      { label: "Market", value: "Spain first" },
      { label: "Model", value: "Free swaps" },
