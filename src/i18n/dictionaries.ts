...
const en = {
  ...
  shop: {
    ...
    pageBlurb:
      "Plugins, extensions, templates, and other digital goods — instant download after payment.",
    empty: "No listings live yet. Check back soon, or book a live session.",
    buy: "Buy now",
    back: "← Shop",
    bookCta: "Need a live call instead? Book a session →",
  },
  book: {
    pageTitle: "Personal assistance & live calls",
    pageBlurb:
      "Pay for a fixed session, then share a few times that work. I'll confirm by email — no retainers, no agency overhead.",
    how: "After payment you'll land on a success page to suggest availability. I reply to lock the slot.",
    empty: "No session packages are published yet.",
    buy: "Pay & book",
    topic: "What do you want to discuss?",
    shopCta: "Browse digital products →",
  },
  checkout: {
    successTitle: "Payment received",
    successBlurb: "Thanks — your order is confirmed.",
    missingSession: "Missing checkout session. If you paid, check your email for the receipt.",
    processing: "Still confirming with Stripe… refresh in a moment if your download isn't ready.",
    digitalReady: "Your download is ready.",
    download: "Download file",
    downloadEmail: "If the button isn't here yet, use the link in your email (valid 7 days).",
    sessionNext: "Tell me 2–3 windows that work — I'll confirm the call by email.",
    preferredTimes: "Preferred times (with timezone)",
    notes: "Anything I should prepare? (optional)",
    scheduleSubmit: "Send availability",
    scheduleSaved: "Got it — I'll email you to confirm the slot.",
  },
  expertise: {
    eyebrow: "EXPERTISE",
...
const es: Dictionary = {
  ...
  shop: {
    pageTitle: "Tienda digital",
    pageBlurb:
      "Plugins, extensiones, plantillas y otros productos digitales — descarga al instante tras el pago.",
    empty: "Aún no hay listados publicados. Vuelve pronto o reserva una sesión en vivo.",
    buy: "Comprar ahora",
    back: "← Tienda",
    bookCta: "¿Prefieres una llamada? Reserva una sesión →",
  },
  book: {
    pageTitle: "Asistencia personal y llamadas en vivo",
    pageBlurb:
      "Paga una sesión fija y comparte unos horarios. Confirmo por email — sin retainer ni overhead de agencia.",
    how: "Tras el pago, indícanos 2–3 franjas. Respondo para cerrar la cita.",
    empty: "No hay paquetes de sesión publicados todavía.",
    buy: "Pagar y reservar",
    topic: "¿De qué quieres hablar?",
    shopCta: "Ver productos digitales →",
  },
  checkout: {
    successTitle: "Pago recibido",
    successBlurb: "Gracias — tu pedido está confirmado.",
    missingSession: "Falta la sesión de checkout. Si pagaste, revisa el email del recibo.",
    processing: "Confirmando con Stripe… refresca en un momento si la descarga no aparece.",
    digitalReady: "Tu descarga está lista.",
    download: "Descargar archivo",
    downloadEmail: "Si el botón no aparece aún, usa el enlace del email (válido 7 días).",
    sessionNext: "Indica 2–3 franjas — confirmaré la llamada por email.",
    preferredTimes: "Horarios preferidos (con zona horaria)",
    notes: "¿Algo que deba preparar? (opcional)",
    scheduleSubmit: "Enviar disponibilidad",
    scheduleSaved: "Recibido — te escribiré para confirmar la cita.",
  },
  expertise: {
    eyebrow: "EXPERTISE",
